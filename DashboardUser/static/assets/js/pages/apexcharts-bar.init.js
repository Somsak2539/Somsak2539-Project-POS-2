...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let chartInstance = null; // ✅ เก็บ chart instance ไว้ตรงนี้

    function updateChart(productNames, salesData) {
        const chartContainer = document.querySelector("#basicBar");
        ...
        // ✅ กำหนดความสูงของกราฟตามจำนวนรายการ
        const dynamicHeight = productNames.length * 35;
        ...
        const options = {
            ...
            chart: {
                type: 'bar',
                height: dynamicHeight, // กำหนดความสูงให้ chart ด้วย
            },
            plotOptions: {
                bar: {
                    borderRadius: 4,
        ...
        // ✅ สร้างกราฟใหม่ และเก็บไว้ในตัวแปร
